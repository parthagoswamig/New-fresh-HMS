...
export default function NewOPDVisitPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await opdService.create(payload, tenant?.id || '');
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
      <div className="mb-6">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">New OPD Visit</h1>
        <p className="text-gray-600 mt-1">Register a new outpatient visit</p>
      </div>
